app\controllers\PaymentsController
===============
...
### request
    ...
    mixed app\controllers\PaymentsController::request()

Request payments
Send email to josh@bywave.com.au via Postmark API
payments/request/$id
method: GET
...
### paid
    ...
    mixed app\controllers\PaymentsController::paid()
