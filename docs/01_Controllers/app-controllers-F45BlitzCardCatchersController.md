app\controllers\F45BlitzCardCatchersController
===============
...
* Class name: F45BlitzCardCatchersController
...
### view_cardcatchers
    ...
    mixed app\controllers\F45BlitzCardCatchersController::view_cardcatchers()
...
### getCardCatchers
    ...
    \app\controllers\[type] app\controllers\F45BlitzCardCatchersController::getCardCatchers()

Returns list of card catchers
...
### postCardCatchers
    ...
    \app\controllers\[type] app\controllers\F45BlitzCardCatchersController::postCardCatchers()

Handles add/update card catchers
...
### postCardHistory
    ...
    \app\controllers\[type] app\controllers\F45BlitzCardCatchersController::postCardHistory()

Handles Card History
...
### deleteCardCatcher
    ...
    \app\controllers\[type] app\controllers\F45BlitzCardCatchersController::deleteCardCatcher()

Handles delete card catchers
...
### getCardCatchersByUserId

    \app\controllers\[type] app\controllers\F45BlitzCardCatchersController::getCardCatchersByUserId()

Return user and its card catchers
