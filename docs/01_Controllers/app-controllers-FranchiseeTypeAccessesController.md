app\controllers\FranchiseeTypeAccessesController
===============
...
* Class name: FranchiseeTypeAccessesController
...
### getFranchiseeAccessTypes

    mixed app\controllers\FranchiseeTypeAccessesController::getFranchiseeAccessTypes()
...
### updateFranchiseeAccessTypes

    mixed app\controllers\FranchiseeTypeAccessesController::updateFranchiseeAccessTypes()
...
### updateFranchiseeTypeAccessesWeek

    mixed app\controllers\FranchiseeTypeAccessesController::updateFranchiseeTypeAccessesWeek($week, $franchisee_id, $typeid)
...
### updateorCreateFranchiseeAccessTypesDetails

    mixed app\controllers\FranchiseeTypeAccessesController::updateorCreateFranchiseeAccessTypesDetails($typeId, $data, $franchisee_id, $action)
