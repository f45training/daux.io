app\controllers\ComplianceFilesController
===============
...
* Class name: ComplianceFilesController
...
### get_franchisee_files

    mixed app\controllers\ComplianceFilesController::get_franchisee_files()
...
### upload_multiple
    ...
    mixed app\controllers\ComplianceFilesController::upload_multiple()
...
### sendMail
    ...
    mixed app\controllers\ComplianceFilesController::sendMail($files)
