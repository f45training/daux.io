app\controllers\TrainerPhotosController
===============
...
* Class name: TrainerPhotosController
...
### approve
    ...
    mixed app\controllers\TrainerPhotosController::approve()
...
### reject
    ...
    mixed app\controllers\TrainerPhotosController::reject()
...
### sendRejectedMail
    ...
    mixed app\controllers\TrainerPhotosController::sendRejectedMail($photo)
