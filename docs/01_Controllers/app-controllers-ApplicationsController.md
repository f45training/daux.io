...
* Class name: ApplicationsController
...
### store
    ...
    mixed app\controllers\ApplicationsController::store()
...
### generateKey
    ...
    mixed app\controllers\ApplicationsController::generateKey()
...
### generateAppKey
    ...
    mixed app\controllers\ApplicationsController::generateAppKey()
