app\controllers\InjuryLogsController
===============
...
* Class name: InjuryLogsController
...
### injuries_per_location

    mixed app\controllers\InjuryLogsController::injuries_per_location()
...
### injuries_per_program

    mixed app\controllers\InjuryLogsController::injuries_per_program()
...
### generate_weekly_injury_logs_csv

    mixed app\controllers\InjuryLogsController::generate_weekly_injury_logs_csv()
...
### generate_csv
    ...
    mixed app\controllers\InjuryLogsController::generate_csv()
...
### outputCSV
    ...
    mixed app\controllers\InjuryLogsController::outputCSV($data)
...
### get_injury_logs
    ...
    mixed app\controllers\InjuryLogsController::get_injury_logs()
...
### get_injury_logs_by_id

    mixed app\controllers\InjuryLogsController::get_injury_logs_by_id()
...
### weekly_report
    ...
    mixed app\controllers\InjuryLogsController::weekly_report()
