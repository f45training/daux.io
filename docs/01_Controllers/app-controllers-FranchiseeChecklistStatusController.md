app\controllers\FranchiseeChecklistStatusController
===============

FranchiseeChecklistStatusController_Class is a class for FranchiseeChecklistStatus Controller




* Class name: FranchiseeChecklistStatusController
...
### getChecklistStatusByReOpen

    array app\controllers\FranchiseeChecklistStatusController::getChecklistStatusByReOpen()

Function getChecklistStatusByReOpen
Get checklist status by reopen
...
### save
    ...
    array app\controllers\FranchiseeChecklistStatusController::save()

Function save
Save status of a checklist
...
### manageUpdates
    ...
    array app\controllers\FranchiseeChecklistStatusController::manageUpdates(array $id, array $data, integer $now, string $user)

Function manageUpdates
Manage of checklist status to update
...
#### Arguments
* $id **array** - &lt;p&gt;an identifier to update&lt;/p&gt;
* $data **array** - &lt;p&gt;contains information of checklist status&lt;/p&gt;
* $now **integer** - &lt;p&gt;current timestamp&lt;/p&gt;
* $user **string** - &lt;p&gt;current user that is performing the acion&lt;/p&gt;
...
### report
    ...
    array app\controllers\FranchiseeChecklistStatusController::report()

Function report
Get list of franchisees by filter
