app\controllers\FranchiseeReopenLogsController
===============

FranchiseeReopenLogsController_Class is a class for FranchiseeReopenLogs Controller




* Class name: FranchiseeReopenLogsController
...
### addReopenProcess
    ...
    array app\controllers\FranchiseeReopenLogsController::addReopenProcess()

Function addReopenProcess
Add new reopen process for a certain franchisee checklist type
...
### getReOpenOnProcessByType

    object app\controllers\FranchiseeReopenLogsController::getReOpenOnProcessByType()

Function getReOpenOnProcessByType
Get reopen by type that is currently on process
...
### updateReOpenOnboarded

    array app\controllers\FranchiseeReopenLogsController::updateReOpenOnboarded()

Function updateReOpenOnboarded
Update on boarded status and date by reopen
...
### getReOpenOnboarded
    ...
    array app\controllers\FranchiseeReopenLogsController::getReOpenOnboarded()

Function getReOpenOnboarded
Get on boarded status and date by reopen
