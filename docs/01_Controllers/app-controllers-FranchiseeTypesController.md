app\controllers\FranchiseeTypesController
===============
...
* Class name: FranchiseeTypesController
...
### duplicateEntryInWorkout

    mixed app\controllers\FranchiseeTypesController::duplicateEntryInWorkout()

Duplicate/Copy a workout but change the franchisee type
...
### getFranchiseeTypes
    ...
    mixed app\controllers\FranchiseeTypesController::getFranchiseeTypes()
