app\controllers\WebsiteLeadsController
===============
...
* Class name: WebsiteLeadsController
...
### getWebsiteLeads
    ...
    mixed app\controllers\WebsiteLeadsController::getWebsiteLeads()
...
### getPreviousLeads
    ...
    mixed app\controllers\WebsiteLeadsController::getPreviousLeads($data_object)
...
### send_website_approval
    ...
    mixed app\controllers\WebsiteLeadsController::send_website_approval()
...
### getLeadsPerSite
    ...
    mixed app\controllers\WebsiteLeadsController::getLeadsPerSite()
...
### getLeadsPerDay
    ...
    mixed app\controllers\WebsiteLeadsController::getLeadsPerDay()
...
### playbook_leads
    ...
    mixed app\controllers\WebsiteLeadsController::playbook_leads()
...
### getFranchiseeLeads
    ...
    mixed app\controllers\WebsiteLeadsController::getFranchiseeLeads()
...
### getLeadsCsv
    ...
    mixed app\controllers\WebsiteLeadsController::getLeadsCsv()
...
### getLatestGenerate
    ...
    mixed app\controllers\WebsiteLeadsController::getLatestGenerate()
