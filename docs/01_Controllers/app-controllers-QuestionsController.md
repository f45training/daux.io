app\controllers\QuestionsController
===============
...
* Class name: QuestionsController
...
### get_questions_by_section_id

    mixed app\controllers\QuestionsController::get_questions_by_section_id()
...
### post_correct_answers

    mixed app\controllers\QuestionsController::post_correct_answers()
...
### get_correct_answer
    ...
    mixed app\controllers\QuestionsController::get_correct_answer()
...
### post_multiple_answers

    mixed app\controllers\QuestionsController::post_multiple_answers()
...
### get_multi_answers_by_question_id

    mixed app\controllers\QuestionsController::get_multi_answers_by_question_id()
...
### deleteMultipleAnswerById

    mixed app\controllers\QuestionsController::deleteMultipleAnswerById()
