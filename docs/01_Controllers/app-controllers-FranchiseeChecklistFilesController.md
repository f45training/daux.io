app\controllers\FranchiseeChecklistFilesController
===============

FranchiseeChecklistFilesController_Class is a class for FranchiseeChecklistFiles Controller




* Class name: FranchiseeChecklistFilesController
...
### upload
    ...
    array app\controllers\FranchiseeChecklistFilesController::upload()

Function upload
Upload checklist files and save its information
...
### handleFileLogs
    ...
    void app\controllers\FranchiseeChecklistFilesController::handleFileLogs(array $data, integer $action)

Function handleFileLogs
Upload checklist files and save its information
...
#### Arguments
* $data **array** - &lt;p&gt;contains file data to be created&lt;/p&gt;
* $action **integer** - &lt;p&gt;determines the type or mode of action to perform&lt;/p&gt;



### get

    array app\controllers\FranchiseeChecklistFilesController::get()

Function get
Get checklist files by reopen log id and checklist id
...
### download
    ...
    void app\controllers\FranchiseeChecklistFilesController::download()
