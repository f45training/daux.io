app\controllers\EmailSignatureController
===============
...
* Class name: EmailSignatureController
...
### retreieveEmailSignature

    \app\controllers\[type] app\controllers\EmailSignatureController::retreieveEmailSignature()
...
### update_EmailSignature

    mixed app\controllers\EmailSignatureController::update_EmailSignature()
...
### countryList
    ...
    mixed app\controllers\EmailSignatureController::countryList()
