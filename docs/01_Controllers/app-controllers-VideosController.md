app\controllers\VideosController
===============
...
### $clientId
    ...
    private mixed $clientId = '47deaf217b4c4162cae0e594b471560a28d7327f'
...
### $clientSecret
    ...
    private mixed $clientSecret = 'njb6nUZJB4/mzJkGr6+eO1av5SCJhCTsEuNJA5JedtesGbGZIVlOjRPlewwRs8LRgkndNXcyXG2SR/rcbj2d+TNV+yyl/DR5tjTYmA80o9fRakFv8cQtpjPVVofAuDGf'
...
### $accessToken
    ...
    private mixed $accessToken = 'a63fe8f7a16c86be8a3b4365ef5ac866'
...
### cacheVideos
    ...
    mixed app\controllers\VideosController::cacheVideos($page, $batch)
...
### cacheLaunchPathwayVideos

    mixed app\controllers\VideosController::cacheLaunchPathwayVideos($page, $batch)

Called by cacheVideos, this will be doing for items based on launch-pathway, for some reason some videos are not in index vimeo
...
### playlist
    ...
    mixed app\controllers\VideosController::playlist()

v1/videos/playlist
fetch mp3 files from s3 inside beats folder
