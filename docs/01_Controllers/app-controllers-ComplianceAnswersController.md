app\controllers\ComplianceAnswersController
===============
...
* Class name: ComplianceAnswersController
...
### sendComplianceEmail
    ...
    mixed app\controllers\ComplianceAnswersController::sendComplianceEmail($franchise_id, $note, $files, $emails, $questions, $post_data, $gym_name)
...
### sendEmailToStudio
    ...
    mixed app\controllers\ComplianceAnswersController::sendEmailToStudio($params)
...
### save_issue
    ...
    mixed app\controllers\ComplianceAnswersController::save_issue($data_entry)
...
### saveUploadFiles
    ...
    mixed app\controllers\ComplianceAnswersController::saveUploadFiles()
...
### get_franchisee_answers

    mixed app\controllers\ComplianceAnswersController::get_franchisee_answers()
