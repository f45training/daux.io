app\controllers\SupportController
===============
...
### assign
    ...
    mixed app\controllers\SupportController::assign()

v1/support/assign - GET
#25150 - Assigns not functioning now gyms freshdesk ticket to their onboard manager
...
### requestor
    ...
    mixed app\controllers\SupportController::requestor()

Update requestor info to studio name
...
### user
    ...
    mixed app\controllers\SupportController::user($email)
...
### obm
    ...
    mixed app\controllers\SupportController::obm($query)
