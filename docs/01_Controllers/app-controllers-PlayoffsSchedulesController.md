app\controllers\PlayoffsSchedulesController
===============
...
* Class name: PlayoffsSchedulesController
...
### trigger
    ...
    mixed app\controllers\PlayoffsSchedulesController::trigger()

Trigger Allow Playoffs if date is equal to current
