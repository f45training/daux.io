app\controllers\FranchiseeEmploymentsController
===============
...
* Class name: FranchiseeEmploymentsController
...
### set_contract
    ...
    mixed app\controllers\FranchiseeEmploymentsController::set_contract()

Set Contract
v1/franchisee_employments/set_contract/{id}
...
### get_contract
    ...
    mixed app\controllers\FranchiseeEmploymentsController::get_contract()
...
### reactivate_contract
    ...
    mixed app\controllers\FranchiseeEmploymentsController::reactivate_contract()
...
### get_employment_infos

    mixed app\controllers\FranchiseeEmploymentsController::get_employment_infos()
...
### store_employment_info

    mixed app\controllers\FranchiseeEmploymentsController::store_employment_info()

Store Employment Info
/v1/controller/store_employment_info
...
### activate_employment_question

    mixed app\controllers\FranchiseeEmploymentsController::activate_employment_question()

Activate Employment Questions
/v1/controller/activate_employment_questions
...
### send_email_employment_pdf

    mixed app\controllers\FranchiseeEmploymentsController::send_email_employment_pdf($id, $pdf)

Send Employment Email
/admin/controller/send_email_employment_pdf
...
### getEmailEnv
    ...
    mixed app\controllers\FranchiseeEmploymentsController::getEmailEnv()

Get EmailEnv
admin/franchisee_employments/getEmailEnv
