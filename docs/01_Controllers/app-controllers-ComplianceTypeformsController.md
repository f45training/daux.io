app\controllers\ComplianceTypeformsController
===============
...
* Class name: ComplianceTypeformsController
...
### get
    ...
    mixed app\controllers\ComplianceTypeformsController::get()
...
### delete_compliance
    ...
    mixed app\controllers\ComplianceTypeformsController::delete_compliance()
...
### save
    ...
    mixed app\controllers\ComplianceTypeformsController::save()
...
### sendComplianceTypeForm

    mixed app\controllers\ComplianceTypeformsController::sendComplianceTypeForm($request, $qa)
...
### getComplianceTypeformsAnswers

    mixed app\controllers\ComplianceTypeformsController::getComplianceTypeformsAnswers()
...
### deletecompliancetypeformanswer

    mixed app\controllers\ComplianceTypeformsController::deletecompliancetypeformanswer()
...
### generatePDF
    ...
    mixed app\controllers\ComplianceTypeformsController::generatePDF()
...
### downloadRenderPdf
    ...
    mixed app\controllers\ComplianceTypeformsController::downloadRenderPdf()
...
### set_redirect_uri
    ...
    mixed app\controllers\ComplianceTypeformsController::set_redirect_uri()
