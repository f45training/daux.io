app\controllers\DivisionQuestionsController
===============
...
* Class name: DivisionQuestionsController
...
### answers
    ...
    mixed app\controllers\DivisionQuestionsController::answers()

Save division answers
POST
v1/division_questions/answers/
