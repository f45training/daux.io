app\controllers\FranchiseeChecklistTypesController
===============
...
* Class name: FranchiseeChecklistTypesController
...
### all
    ...
    mixed app\controllers\FranchiseeChecklistTypesController::all()
