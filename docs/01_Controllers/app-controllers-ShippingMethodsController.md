app\controllers\ShippingMethodsController
===============
...
* Class name: ShippingMethodsController
...
### isStatusFixRest
    ...
    mixed app\controllers\ShippingMethodsController::isStatusFixRest()

Get Shipping Method if fix
POSt /shipping_estimate/checkIfFix/{:shipping_method:}
