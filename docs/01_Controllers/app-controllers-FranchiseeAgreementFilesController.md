app\controllers\FranchiseeAgreementFilesController
===============
...
* Class name: FranchiseeAgreementFilesController
...
### saveCrecheRequestData

    mixed app\controllers\FranchiseeAgreementFilesController::saveCrecheRequestData()

Save Creche RequestData
v1/franchisee_agreement_files/add/{:franchisee_id:[0-9]+}
...
### sendEmail
    ...
    mixed app\controllers\FranchiseeAgreementFilesController::sendEmail($studio_id, $data)

Send Email
admin/franchisee_agreement_files/sendEmail
...
### getEmailEnv
    ...
    mixed app\controllers\FranchiseeAgreementFilesController::getEmailEnv()

Get EmailEnv
admin/franchisee_agreement_files/getEmailEnv
