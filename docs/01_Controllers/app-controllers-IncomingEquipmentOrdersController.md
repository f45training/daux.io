app\controllers\IncomingEquipmentOrdersController
===============
...
* Class name: IncomingEquipmentOrdersController
...
### log_per_franchise
    ...
    mixed app\controllers\IncomingEquipmentOrdersController::log_per_franchise()
...
### getLogs
    ...
    mixed app\controllers\IncomingEquipmentOrdersController::getLogs()
...
### orderFormLogs
    ...
    array app\controllers\IncomingEquipmentOrdersController::orderFormLogs()

INPUT: Type POST; Franchisee ID on the route; JSON Data on POST
OUTPUT: Success True or False (with error)
ALERTS: No Alert
...
### updateLog
    ...
    array app\controllers\IncomingEquipmentOrdersController::updateLog()

INPUT: Log ID;
Updates the log status if it was resent from the admin page.

OUTPUT: returns success as well as the log id.
