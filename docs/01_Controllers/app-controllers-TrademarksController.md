app\controllers\TrademarksController
===============
...
* Class name: TrademarksController
...
### deleteTradeMarkDetail

    \app\controllers\[type] app\controllers\TrademarksController::deleteTradeMarkDetail()

Handles delete operation TrademarksD
...
### getTrademarkDetailById
    ...
    \app\controllers\[type] app\controllers\TrademarksController::getTrademarkDetailById()

Return TrademarkD object
