app\controllers\FreshdeskLogsController
===============
...
* Class name: FreshdeskLogsController
...
### saveFreshdeskData
    ...
    mixed app\controllers\FreshdeskLogsController::saveFreshdeskData()

Save freshdesk's yesterday's data to freshdesk_logs
...
### get_freshdesk_tickets

    mixed app\controllers\FreshdeskLogsController::get_freshdesk_tickets()
...
### get_and_assigned_ticket

    mixed app\controllers\FreshdeskLogsController::get_and_assigned_ticket()
...
### save_freshdesk_log_bydate

    mixed app\controllers\FreshdeskLogsController::save_freshdesk_log_bydate()
...
### validateDate
    ...
    mixed app\controllers\FreshdeskLogsController::validateDate($date)
...
### getDifference
    ...
    mixed app\controllers\FreshdeskLogsController::getDifference($from, $to)
