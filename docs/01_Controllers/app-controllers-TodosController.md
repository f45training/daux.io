app\controllers\TodosController
===============
...
### update_todo
    ...
    mixed app\controllers\TodosController::update_todo()
...
### get_last_completed
    ...
    mixed app\controllers\TodosController::get_last_completed()
