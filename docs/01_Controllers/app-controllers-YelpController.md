app\controllers\YelpController
===============
...
### download_report
    ...
    mixed app\controllers\YelpController::download_report()
...
### send_yelp_report
    ...
    mixed app\controllers\YelpController::send_yelp_report()
...
### send_sparkpost_report

    mixed app\controllers\YelpController::send_sparkpost_report($link)
