app\controllers\SignageController
===============
...
### files
    ...
    mixed app\controllers\SignageController::files()

Files
ROUTE: v1/signage/files/$status/franchisee/$franchisee_id
