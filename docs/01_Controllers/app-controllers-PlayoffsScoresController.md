app\controllers\PlayoffsScoresController
===============
...
* Class name: PlayoffsScoresController
...
### $exercises
    ...
    public mixed $exercises = array(array('name' => 'ROWING', 'goal' => 290), array('name' => 'BENCH HOPS', 'goal' => 95), array('name' => 'TRX PUSH UP + KNEE TUCK', 'goal' => 57), array('name' => '5 CONE LATERAL HOP', 'goal' => 130), array('name' => 'BOX JUMP BURPEE', 'goal' => 20), array('name' => 'CHIN UPS', 'goal' => 25), array('name' => 'BB SQAUT PRESS', 'goal' => 36), array('name' => 'MB RUSSIAN TWIST', 'goal' => 87), array('name' => 'DEADBALL DROP OVER SHOULDER', 'goal' => 27), array('name' => 'HURDLE HOP AND SPRINT', 'goal' => 15))
...
### getScore
    ...
    mixed app\controllers\PlayoffsScoresController::getScore()
...
### getRankings
    ...
    mixed app\controllers\PlayoffsScoresController::getRankings()
...
### getAllScores
    ...
    mixed app\controllers\PlayoffsScoresController::getAllScores()
...
### deleteScore
    ...
    mixed app\controllers\PlayoffsScoresController::deleteScore()
...
### getFranchiseeByCountry

    mixed app\controllers\PlayoffsScoresController::getFranchiseeByCountry()
