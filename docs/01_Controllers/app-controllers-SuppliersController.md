app\controllers\SuppliersController
===============
...
* Class name: SuppliersController
...
### franchisees
    ...
    mixed app\controllers\SuppliersController::franchisees()
...
### home
    ...
    mixed app\controllers\SuppliersController::home()
...
### formValidations
    ...
    \app\controllers\$errors app\controllers\SuppliersController::formValidations($id)
...
### paid
    ...
    mixed app\controllers\SuppliersController::paid()

Send Email Suppliers
...
### sendPO
    ...
    mixed app\controllers\SuppliersController::sendPO()
