app\controllers\StatusChecklistSettingsController
===============
...
* Class name: StatusChecklistSettingsController
...
### getAllStatusChecklists

    mixed app\controllers\StatusChecklistSettingsController::getAllStatusChecklists()
...
### getAllStatusValue
    ...
    mixed app\controllers\StatusChecklistSettingsController::getAllStatusValue()
...
### getAllStatusSubChecklists

    mixed app\controllers\StatusChecklistSettingsController::getAllStatusSubChecklists()
...
### updateStatusChecklistSetting

    mixed app\controllers\StatusChecklistSettingsController::updateStatusChecklistSetting()
...
### deleteEmailStatusChecklistSetting

    mixed app\controllers\StatusChecklistSettingsController::deleteEmailStatusChecklistSetting()
...
### updateStatusChecklists
    ...
    mixed app\controllers\StatusChecklistSettingsController::updateStatusChecklists()
...
### updateStatusPBbuttons

    mixed app\controllers\StatusChecklistSettingsController::updateStatusPBbuttons()
...
### deleteStatusChecklistPBbuttons

    mixed app\controllers\StatusChecklistSettingsController::deleteStatusChecklistPBbuttons()
...
### updateStatusSubChecklists

    mixed app\controllers\StatusChecklistSettingsController::updateStatusSubChecklists()
...
### addStatusChecklists
    ...
    mixed app\controllers\StatusChecklistSettingsController::addStatusChecklists()
...
### deleteStatusChecklist

    mixed app\controllers\StatusChecklistSettingsController::deleteStatusChecklist()
...
### addSubStatusChecklists

    mixed app\controllers\StatusChecklistSettingsController::addSubStatusChecklists()
...
### deleteSubStatusChecklist

    mixed app\controllers\StatusChecklistSettingsController::deleteSubStatusChecklist()
